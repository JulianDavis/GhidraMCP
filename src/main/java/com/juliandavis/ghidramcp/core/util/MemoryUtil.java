package com.juliandavis.ghidramcp.core.util;
 ...
 * Provides methods for manipulating memory data, such as grouping contiguous memory
 * writes and creating information maps from memory write data.
 */
